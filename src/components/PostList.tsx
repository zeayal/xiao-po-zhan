...
function PostCardItem({title, avatar, desc, photo, author, createTime}) {
    ...
    return (
        <div className="flex flex-col w-full my-4 cursor-pointer  hover:scale-105 transition ease-in-out delay-150">
            <div className="relative w-full h-52 rounded-lg overflow-hidden ">
                <Image alt="photo" src={photo} fill />
            </div>
          
            <h2 className="text-xl mt-3 py-2">{title}</h2>
            <p className="text-[#333]">{desc}</p>
            <div className="flex items-center mt-2 text-[#666] text-sm">
